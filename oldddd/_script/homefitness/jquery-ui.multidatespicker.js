(function($) {
        ...
        var methods = {
                ...
                var mdp_events = {
                    ...
                    onSelect: function(dateText, inst) {
                        ...
                        if (this.multiDatesPicker.mode == "normal" && this.multiDatesPicker.pickableRange)
                                    ...
                                    do {
                                        ...
                                        for (var i = 0; i < disabled.length; i++)
                                            if (disabled[i].getTime() <= max_date.getTime()) {
                                                if (min_date.getTime() <= disabled[i].getTime() && disabled[i].getTime() <= max_date.getTime()) c_disabled++;
                                                disabled.splice(i, 1);
                                                i--
                            ...
                            } else $this.datepicker("option",
                                "minDate", this.multiDatesPicker.minDate).datepicker("option", "maxDate", this.multiDatesPicker.maxDate);
            ...
            dateConvert: function(date, desired_format, dateFormat) {
                ...
                if (!dateFormat) {
                    ...
                    if (dp_dateFormat) dateFormat = dp_dateFormat;
                    else dateFormat =
            ...
            gotDate: function(date, type) {
                if (!type) type = "picked";
                for (var i = 0; i < this.multiDatesPicker.dates[type].length; i++)
                    if (methods.compareDates.call(this, this.multiDatesPicker.dates[type][i], date) === 0) return i;
                return false
            },
            value: function(value) {
                if (value && typeof value == "string") methods.addDates.call(this, value.split(this.multiDatesPicker.separator));
                else {
            ...
            getDates: function(format, type) {
                ...
                switch (format) {
                    ...
                    case "number":
                        ...
                        for (var i in this.multiDatesPicker.dates[type]) o_dates.push(dateConvert.call(this, this.multiDatesPicker.dates[type][i], format));
                        return o_dates;
                    default:
            ...
            addDates: function(dates, type) {
                if (dates.length > 0) {
                    ...
                    switch (typeof dates) {
                        ...
                        case "array":
                            if (dates.length) {
                                for (var i = 0; i <
                                dates.length; i++) addDate.call(this, dates[i], type, true);
                ...
                } else $.error("Empty array of dates received.")
            },
            removeDates: function(dates, type) {
                ...
                if (Object.prototype.toString.call(dates) === "[object Array]")
                    for (var i in dates.sort(function(a, b) {
                        return b - a
                    })) removed.push(removeDate.call(this,
                        dates[i], type));
                else removed.push(removeDate.call(this, dates, type));
                return removed
            },
            removeIndexes: function(indexes, type) {
                ...
                else removed.push(removeIndex.call(this, indexes, type));
                return removed
            },
            ...
            toggleDate: function(date,
                ...
                switch (this.multiDatesPicker.mode) {
                    case "daysRange":
                        ...
                        break;
                    default:
                        if (methods.gotDate.call(this, date) === false) methods.addDates.call(this,
                            date, type);
            ...
            if (methods[method]) {
                ...
                switch (method) {
                    ...
                    case "addDates":
                        ...
                        if (altField !== undefined && altField != "") $(altField).val(dates_string);
                ...
                return exec_result
            } else if (typeof method === "object" || !method) return methods.init.apply(this, mdp_arguments);
            else $.error("Method " + method + " does not exist on jQuery.multiDatesPicker");
            return false
        });
        return ret
    };
    ...
    $.multiDatesPicker._hideDatepicker =
        $.datepicker._hideDatepicker;
    $.datepicker._hideDatepicker = function() {
        var target = this._curInst.input[0];
        var mdp = target.multiDatesPicker;
        if (!mdp || this._curInst.inline === false && !mdp.changed) return $.multiDatesPicker._hideDatepicker.apply(this, arguments);
        else {
            mdp.changed = false;
