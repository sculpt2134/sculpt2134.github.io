(function () {
  ...
  const locales = {
    en: {
      ...
      daysShort: ["S", "M", "T", "W", "T", "F", "S"],//HCAU modify -default ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
      daysMin: ["S", "M", "T", "W", "T", "F", "S"],//HCAU modify -default  ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"],
      months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
      monthsShort: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],//HCAU modify -default ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
      today: "Today",
      clear: "Clear",
      titleFormat: "MM y"
    }
  ...
  const defaultOptions = {
    ...
    format: 'dd/mm/yyyy', //HCAU modify- default mm/dd/yyyy
    language: 'en',
    maxDate: null,
    maxNumberOfDates: 1,
    maxView: 3,
    minDate: null,
    nextArrow: '▶',//HCAU modify
    orientation: 'auto',
    pickLevel: 0,
    prevArrow: '◀',//HCAU modify
    showDaysOfWeek: true,
    showOnClick: true,
    showOnFocus: true,
    startView: 0,
    ...
    updateOnBlur: true,
    weekNumbers: 0,
    weekStart: 1,//HCAU modify- default 0
  };
